...
// Staff mutation bodies are small field updates; 8 KiB is generous.
const STAFF_BODY_MAX_BYTES = 8 * 1024;
...
export async function POST(request: Request) {
  ...
  try {
    body = await readBoundedJsonObject(request, STAFF_BODY_MAX_BYTES);
  } catch (error) {
